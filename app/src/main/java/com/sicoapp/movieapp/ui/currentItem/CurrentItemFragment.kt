...
class CurrentItemFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var toprated = TopRated(0,"","","https://picsum.photos/536/354")

        callback = object : CallbackList {
            override fun listToFragment(responseTopRated: TopRated) {

                toprated = TopRated(responseTopRated.id,"","","https://image.tmdb.org/t/p/w185/" + responseTopRated.poster_path)

            }
        }
        binging.data = viewModel
        binging.movie = toprated
