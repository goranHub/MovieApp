...
import com.sicoapp.movieapp.ui.movie.crew.CastObservable

/**
 * @author ll4
 * @date 12/11/2020
 */
class CrewMovieAdapter: RecyclerView.Adapter<ViewHolder>(){

    var list = mutableListOf<CastObservable>()
    ...
    fun addCast(crewItems: List<CastObservable>) {
